...
export default function HeroSection() {
  ...
  return (
    <section className="relative z-0 h-[430px] w-full overflow-hidden sm:h-[520px] lg:h-[720px]">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-end">
        <div className="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-5 lg:px-8 lg:pb-24">
          <div className="text-right text-white lg:max-w-2xl">
            ...
            <div className="pointer-events-auto mt-5 flex flex-wrap items-center justify-end gap-3">
              <Link
                href="/products"
            ...
            <div className="pointer-events-auto mt-5 flex items-center justify-end gap-2">
              {slides.map((_, index) => (
                <button
                  key={index}
                  type="button"
